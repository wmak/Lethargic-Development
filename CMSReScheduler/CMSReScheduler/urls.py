...
urlpatterns = patterns('',
    ...
    url(r'^add_course/$', 'CMSReScheduler.views.add_course', name='add_course'),
    url(r'^delete_course/$', 'CMSReScheduler.views.delete_course', name='delete_course'),
    url(r'^switch_course/$', 'CMSReScheduler.views.switch_course', name='switch_course'),
    url(r'^instructors/(?P<department_name>.*)$', 'CMSReScheduler.views.instructors', name='instructors'),
    ...
    url(r'^admin/schedule/(?P<instructor_name>.*)/$', 'CMSReScheduler.views.admin_schedule'),
